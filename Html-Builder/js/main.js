function addTitle () {
  ...
  var newContentn = document.createTextNode("<h1> Titre </h1>"); 
...
function addPar() {
  ...
  var newContent1n = document.createTextNode("<p> paragraph </p>"); 
  newp1n.appendChild(newContent1n);  
  document.getElementById("code").appendChild(newp1n);
	var newp1 = document.createElement("p"); 
  var newContent1 = document.createTextNode("paragraph"); 
...
function addOl(){
  ...
  var newContentoln = document.createTextNode(`<ol> Organized list`); 
  newoln.appendChild(newContentoln);
  var newlin = document.createElement("p"); 
  var newContentlin = document.createTextNode("<li> Organized list item<li>"); 
  newlin.appendChild(newContentlin);
  newoln.appendChild(newlin)
  var newlin3 = document.createElement("p"); 
  var newContentlin3 = document.createTextNode("<li> Organized list item</li>"); 
  newlin3.appendChild(newContentlin3);
  newoln.appendChild(newlin3)
   var newlin2 = document.createElement("p"); 
  var newContentlin2 = document.createTextNode("<li> Organized list item</li>"); 
  ...
  var newContentol = document.createTextNode("Organized list"); 
  newol.appendChild(newContentol);  
   var newli = document.createElement("li"); 
  var newContentli = document.createTextNode("Organized list item"); 
  newli.appendChild(newContentli);
  newol.appendChild(newli);
    var newli2 = document.createElement("li"); 
  var newContentli2 = document.createTextNode("Organized list item"); 
  newli2.appendChild(newContentli2);
  newol.appendChild(newli2);
  var newli3 = document.createElement("li"); 
  var newContentli3 = document.createTextNode("Organized list item"); 
...
function addUl(){
  ...
  var newContentuln = document.createTextNode("<ul> Unorganized list"); 
  newuln.appendChild(newContentuln);
  var newlin1 = document.createElement("p"); 
  var newContentlin1 = document.createTextNode("<li> Unorganized list item</li>"); 
  newlin1.appendChild(newContentlin1);
  newuln.appendChild(newlin1);
  var newlin31 = document.createElement("p"); 
  var newContentlin31 = document.createTextNode("<li> Unorganized list item</li>"); 
  newlin31.appendChild(newContentlin31);
  newuln.appendChild(newlin31);
   var newlin21 = document.createElement("p"); 
  var newContentlin21 = document.createTextNode("<li> Unoganized list item</li>"); 
  ...
  var newContentul = document.createTextNode("Unorganized list"); 
  newul.appendChild(newContentul);  
   var newli1 = document.createElement("li"); 
  var newContentli1 = document.createTextNode("Unorganized list item"); 
  newli1.appendChild(newContentli1);
  newul.appendChild(newli1);
    var newli21 = document.createElement("li"); 
  var newContentli21 = document.createTextNode("Unorganized list item"); 
  newli21.appendChild(newContentli21);
  newul.appendChild(newli21);
  var newli31 = document.createElement("li"); 
  var newContentli31 = document.createTextNode("Unorganized list item"); 
...
function addVid(){
	...
	var newContentvidn = document.createTextNode("<iframe width='360' height='250' src='res/video.mp4'></iframe>")
	...
	newvid.setAttribute("src","res/video.mp4");
...
function addLink(){
	...
	var newContentlinkn = document.createTextNode("<a href='https://github.com/Smadhi92'>My profile Github</a>");
	...
	newlink.setAttribute("href","https://github.com/Smadhi92");
	var newcontentlink = document.createTextNode("My profile Github");
...
function addAud(){
	...
	var newContentaudn2 = document.createTextNode("<source src='res/audio.mp3' type='audio/mpeg'>");
	...
	newaud.setAttribute("src","res/audio.mp3");
